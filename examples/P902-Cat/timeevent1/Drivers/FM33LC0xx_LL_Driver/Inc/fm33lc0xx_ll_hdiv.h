...
#ifndef __FM33LC0XX_HDIV_H
#define __FM33LC0XX_HDIV_H
...
/** @addtogroup FM33LC0XX_Driver_HDIV
  ...
  */
/* Exported types -------------------------------------------------------------------------------------*/
/** @defgroup HDIV_ES_INIT HDIV Exported Init structures
  * @{
  */
...
#define    HDIV_SR_BUSY_TIMEOUT                                (0xFFFU)
...
/**
  ...
  * @rmtoll   END        HDIV_SetDivisorEnd
  * @param    HDIVx HDIV instance
  * @param    number 
  * @retval   None
  */
__STATIC_INLINE void HDIV_SetDivisorEnd(HDIV_Type* HDIVx, int32_t number)
{
...
/**
  ...
  * @rmtoll   END        HDIV_GetDivisorEnd
  * @param    HDIVx HDIV instance
  * @retval   
  */
__STATIC_INLINE int32_t HDIV_GetDivisorEnd(HDIV_Type* HDIVx)
{
...
/**
  ...
  * @rmtoll   SOR        HDIV_SetDivisor
  * @param    HDIVx HDIV instance
  * @param    number 
  * @retval   None
  */
__STATIC_INLINE void HDIV_SetDivisor(HDIV_Type* HDIVx, int32_t number)
{
...
/**
  ...
  * @rmtoll   SOR        HDIV_GetDivisor
  * @param    HDIVx HDIV instance
  * @retval   
  */
__STATIC_INLINE int32_t HDIV_GetDivisor(HDIV_Type* HDIVx)
{
...
/**
  ...
  * @rmtoll   QUOT        HDIV_GetQuotient
  * @param    HDIVx HDIV instance
  * @retval   
  */
__STATIC_INLINE int32_t HDIV_GetQuotient(HDIV_Type* HDIVx)
{
...
/**
  ...
  * @rmtoll   REMD        HDIV_GetResidue
  * @param    HDIVx HDIV instance
  * @retval   
  */
__STATIC_INLINE int32_t HDIV_GetResidue(HDIV_Type* HDIVx)
{
...
/**
  ...
  * @rmtoll   SR    DIV_BY_0    HDIV_IsActiveDividedZero
  * @param    HDIVx HDIV instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t HDIV_IsActiveDividedZero(HDIV_Type* HDIVx)
{
...
/**
  * @brief    Get Busy flag
  * @rmtoll   SR    BUSY    HDIV_IsActiveBusy
  * @param    HDIVx HDIV instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t HDIV_IsActiveBusy(HDIV_Type* HDIVx)
{
...
/** @defgroup HDIV_EF_Init Initialization and de-initialization functions
  * @{
  */
