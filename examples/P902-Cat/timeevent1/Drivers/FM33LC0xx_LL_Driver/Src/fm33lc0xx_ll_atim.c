...
/**
  ...
  * @param  TIM_InitStruct 指向一个 @ref ATIM_InitTypeDef(时基配置结构体)
  * @retval ErrorStatus枚举值	
  *			-FAIL 配置过程发生错误        
  *			-PASS 成功  
  */
...
/**
  * @brief	设置 ATIM_InitTypeDef 为默认配置
  * @param 	TIM_InitStruct 指向需要将值设置为默认配置的结构体 @ref ATIM_InitTypeDef 结构体  
  *         
  * @retval	None
  */
...
/**
  ...
  * @param  TIMx Timer Instance
  * @param  TIM_InitStruct 指向一个 @ref ATIM_SlaveInitTypeDef 结构体 
  * @retval ErrorStatus枚举值	
  *			-FAIL 配置过程发生错误        
  *			-PASS 成功  
  */ 
...
/**
  * @brief	设置 ATIM_SlaveInitTypeDef 为默认配置
  * @param 	TIM_InitStruct 指向需要将值设置为默认配置的结构体 @ref ATIM_SlaveInitTypeDef 结构体  
  *         
  * @retval	None
  */
...
/**
  ...
  * @param  TIM_IC_InitStruct 指向一个 @ref ATIM_IC_InitTypeDef 结构体
...
/**
  * @brief	设置 ATIM_IC_InitTypeDef 为默认配置
  * @param 	TIM_ICInitStruct 指向需要将值设置为默认配置的结构体 @ref ATIM_IC_InitTypeDef 结构体  
  *         
  * @retval	None
  */
...
/**
  * @brief	设置 ATIM_OC_InitTypeDef 为默认配置
  * @param 	TIM_OC_InitStruct 指向需要将值设置为默认配置的结构体 @ref ATIM_OC_InitTypeDef 结构体  
  *         
  * @retval	None
  */
...
/**
  ...
  *         @arg @ref ATIM_CHANNEL_3
  *         @arg @ref ATIM_CHANNEL_4
  * @param 	TIM_ICInitStruct 指向需要将值设置为默认配置的结构体 @ref ATIM_IC_InitTypeDef 结构体包含配置参数.
  * @retval	None
  *			-FAIL 配置过程发生错误        
  *			-PASS 成功  
  */
