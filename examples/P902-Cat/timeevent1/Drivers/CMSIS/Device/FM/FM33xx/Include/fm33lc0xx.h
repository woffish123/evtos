...
typedef struct
{
  ...
  __IO uint32_t GRXFSIZ;          /*!< USB Receive Queue size Register,                      Address offset: 0x24 */    
  __IO uint32_t GNPTXFSIZ;        /*!< USB Non-Periodic Transmit Queue size Register,        Address offset: 0x28 */    
  ...
  __IO uint32_t DIEPEMPMSK;       /*!< USB Device IN endpoint Queue empty interrupt Mask Register,Address offset: 0x834 */
  ...
  __IO uint32_t DTXFSTS0;         /*!< USB Device In Endpoint 0 Tranmit Queue Status Register,Address offset: 0x918 */
  ...
  __IO uint32_t DTXFSTS1;         /*!< USB Device In Endpoint 1 Tranmit Queue Status Register,Address offset: 0x938 */
  ...
  __IO uint32_t DIEPTSIZ2;        /*!< USB Device In Endpoint 2 Tranmit Queue Status Register,Address offset: 0x950 */
  __IO uint32_t RSV16;            /*!< Reserved                                                                  */
  __IO uint32_t DTXFSTS2;         /*!< USB Device In Endpoint 2 Tranmit Queue Status Register,Address offset: 0x958 */
